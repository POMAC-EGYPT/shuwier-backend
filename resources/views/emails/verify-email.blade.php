    ...
    <style>
        * {
        ...
        .security-notice {
            ...
            border-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}: 6px solid #fd7e14;
            color: #000000;
            padding: 20px;
            border-radius: 8px;
            margin: 30px 0;
        ...
        .formal-signature .company-info {
            ...
            padding: 20px;
            border-radius: 8px;
            border-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}: 4px solid #1e3c72;
        }
        ...
        <div class="header" style=" color: #1e3c72; padding: 40px 30px; text-align: center;">
            <div class="header-content">
                <div class="company-logo" style="width: 60px; height: 60px; border-radius: 30px; margin: 0 auto 15px; display: block; text-align: center; line-height: 60px;">
                    <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" style="width: 60px; height: 60px; vertical-align: middle; object-fit: contain;">
                </div>
